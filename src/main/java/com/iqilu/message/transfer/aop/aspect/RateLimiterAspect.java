...
import com.iqilu.message.transfer.aop.RateLimiter;
...
public class RateLimiterAspect {
    ...
    @Pointcut("@annotation(com.iqilu.message.transfer.aop.RateLimiter)")
    ...
    public Object pointcut(ProceedingJoinPoint point) throws Throwable {
        ...
        if (rateLimiter != null && rateLimiter.qps() > RateLimiter.NOT_LIMITED) {
            ...
            if (RATE_LIMITER_CACHE.get(method.getName()) != null && !RATE_LIMITER_CACHE.get(method.getName()).tryAcquire(rateLimiter.timeout(), rateLimiter.timeUnit())) {
                throw new InterfaceFrequencyException("您的请求太过频繁了，请稍后再试~");
            }
        }
